...
namespace _05.Slicing_File
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			int parts = 5;
			string sourceFilePath = @"D:\GitHub_Repository\C--Sharp\Streams\05. Slicing File\ShortClip.mp4";
			string destinationDirectory = @"D:\GitHub_Repository\C--Sharp\Streams\05. Slicing File\";
			...
			string assembledDirectory = @"D:\GitHub_Repository\C--Sharp\Streams\05. Slicing File\";
